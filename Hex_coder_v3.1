...
print('\033[5;37;40m 1 -- encode txt to png \033[0;37;40m')
print('\033[5;37;40m 2 -- encode printed text to png \033[0;37;40m')
print('\033[5;37;40m 3 -- decode png to txt \033[0;37;40m')
...
while True:
  ...
  if choose == 1:
    ff = input('write the things you are interested in in the txt file and put its address here >>> ')
    print(PIXELATION(ff))
  elif choose == 2:
    ff = input('paste your text in the given area >>> ')
    print(PIXELATION2(ff))  
  elif choose == 3:
    ff = input('Throw in the address of a picture like "new(numbers).png" along with its above name >>> ')
